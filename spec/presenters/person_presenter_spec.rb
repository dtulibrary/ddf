  ...
  describe 'affiliations' do
    ...
    describe 'previous' do
      ...
      context 'with previous affiliation data' do
        let(:document) {
          Dtu::SolrDocument.new('person_affiliations_ssf' =>
          ["[{\"startDate\":\"20120225\",\"organisation\":{\"names\":[{\"level2\":\"Institut for Vand og Miljøteknologi\",\"level3\":\"Residual Resource Engineering\",\"level4\":\"Level 4\", \"level1\":\"Danmarks Tekniske Universitet\",\"acronym\":\"Residual Resource Engineering\",\"lang\":\"dan\"}]},\"endDate\":\"20130902\",\"type\":\"previous\"}]"])
        }
        it 'contains previous data' do
          expect(subject).not_to be_empty
        end
        it 'groups the affiliation data together' do
          expect(subject).to include 'Danmarks Tekniske Universitet - Institut for Vand og Miljøteknologi - Residual Resource Engineering - Level 4'
        end
      ...
      context "when there are several previous affiliations with the same endDate" do
        let(:document) {
          Dtu::SolrDocument.new('person_affiliations_ssf' =>
          ["[{\"startDate\":\"19900801\",\"organisation\":{\"names\":[{\"level2\":\"Det Sundhedsvidenskabelige Fakultet\",\"level3\":\"First Institut for Klinisk Medicin\",\"level1\":\"Københavns Universitet\",\"acronym\":\"DIAGNOS_FAG\",\"lang\":\"dan\",\"level4\":\"LUKKET: Diagnostiske Fag\"}]},\"endDate\":\"20131003\",\"type\":\"previous\"},        {\"startDate\":\"20110825\",\"organisation\":{\"names\":[{\"level2\":\"Det Sundhedsvidenskabelige Fakultet\",\"level3\":\"Second Institut for Klinisk Medicin \",\"level1\":\"Københavns Universitet\",\"acronym\":\"IKM\",\"lang\":\"dan\"}]},\"endDate\":\"20131003\",\"type\":\"previous\"},{\"startDate\":\"19900801\",\"organisation\":{\"names\":[{\"level2\":\"Det Sundhedsvidenskabelige Fakultet\",\"level3\":\"Institut for Klinisk Medicin\",\"level1\":\"Københavns Universitet\",\"acronym\":\"Inst. Kli. Med.\",\"lang\":\"dan\",\"level4\":\"Institut for Klinisk Medicin\"}]},\"endDate\":\"20140402\",\"type\":\"previous\"}]"]
          )}
          it 'shows all previous affiliations' do
            expect(subject).to include 'First Institut'
            expect(subject).to include 'Second Institut'
          end
        end
      end
    end
