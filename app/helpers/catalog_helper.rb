module CatalogHelper
  ...
  def render_orcid_status(value)
    t "mxd_type_labels.orcid_labels.#{value}"
  end

  def render_active_status(value)
    t "mxd_type_labels.status_labels.#{value}"
  end

  def render_status_index(args)
    render_active_status args[:value]
  end
