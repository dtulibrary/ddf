...
class CatalogController < ApplicationController
  ...
  config.add_facet_field 'scientific_level_s', :label => I18n.t('blacklight.search.fields.facet.scientific_level_s'), :helper_method => :render_format_field_facet
    ...
    config.add_show_field 'language_ss', :label => I18n.t('blacklight.search.fields.show.language_ss'), :helper_method => :render_language
